        ...
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            ...
            <section class="c-attr-jg">
              ...
              <b class="c-yellow" style="font-size:24px;">￥{{ course.price
                }}</b>
            </section>
            <section class="c-attr-mt c-attr-undis">
<span class="c-fff fsize14">主讲： {{ course.teacherName
  }}&nbsp;&nbsp;&nbsp;</span>
            </section>
                      ...
                      <menu id="lh-menu" class="lh-menu mt10 mr10">
                        <ul>
                          ...
                          <li v-for="chapter in chapterList" :key="chapter.id"
                              class="lh-menu-stair">
                            <a :title="chapter.title" href="javascript: void(0)"
                               class="current-1">
                            ...
                            <ol class="lh-menu-ol" style="display: block;">
                              <li v-for="video in chapter.children" :key="video.id"
                                ...
                                <a
                                  ...
                                  <em class="lh-menu-i-2 icon16mr5">&nbsp;</em>{{ video.title }}
                                </a>
                              </li>
                            </ol>
                          </li>
            ...
            <li class="unBr">
              ...
              <div class="of">
                <section class="n-reply-wrap">
                  <fieldset>
                    <textarea name="" v-model="comment.content" placeholder="输入您要
            ...
            <ul class="pr10">
              <li v-for="(comment,index) in data.items" v-bind:key="index">
                ...
                <div class="of mt5">
                  ...
                  ml5">{{comment.createTime}}</font></span>
                </div>
              </li>
            </ul>
          </section>
...
import commonedu from '@/api/commonedu'
export default {
//和页面异步开始的
...
//     },
    initComment(){
      commonedu.getPageList(this.page, this.limit, this.courseId).then(response =>
      {
    ...
    gotoPage(page){
      commonedu.getPageList(page, this.limit,this.courseId).then(response => {
        this.data = response.data.data
      })
    }
  }
